pipeline {
    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                sh './gradlew -b deploy.gradle deploy -Pdev_server=10.28.135.233 -Puser_server=ubuntu -Pkey_path=/var/jenkins_home/omy.pem  -Pjar_path=fatJar -Pjar_name=libhoney-java-example-webapp-1.0.2-capsule'
            }
        }
